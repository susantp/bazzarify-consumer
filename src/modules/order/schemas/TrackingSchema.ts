...
export const OrderTrackingTimelineItemSchema = z
    .object({
        ...
        changed_at: z.preprocess(normalizeTrackingChangedAt, z.iso.datetime().nullable()),
...
export type TOrderTrackingTimelineItem = z.infer<typeof OrderTrackingTimelineItemSchema>;
export type TOrderEstimatedDeliveryWindow = z.infer<typeof OrderEstimatedDeliveryWindowSchema>;
