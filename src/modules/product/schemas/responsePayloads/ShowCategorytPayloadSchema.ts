...
const CategoryBrowsePayloadSchema = z.object({
    current_category: CategoryRecursiveWithImageSchema.extend({
        images: z.array(ImageSchema).optional().nullable()
    }),
    path: z.array(CategoryRecursiveWithImageSchema.extend({
        images: z.array(ImageSchema).optional().nullable()
    })),
    child_categories: z.array(CategoryRecursiveWithImageSchema.extend({
        images: z.array(ImageSchema).optional().nullable()
    })).nullable().optional(),
